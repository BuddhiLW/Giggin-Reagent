...
var o17745 = temp__5718__auto__;
var temp__5718__auto____$1 = (o17745["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o17746 = temp__5718__auto____$1;
return (o17746["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__16920__auto__ = f;
return (o__16920__auto__["toString"]).call(o__16920__auto__);
} else {
return "";
}
}catch (e17747){var _ = e17747;
return "";
}});
...
try{var o__16920__auto___17749 = t;
(o__16920__auto___17749["cljs$lang$ctorPrWriter"]).call(o__16920__auto___17749,t,writer);
}catch (e17748){var __17750 = e17748;
}
...
var char_code = (function (){var o__16920__auto__ = (new String(char$));
return (o__16920__auto__["charCodeAt"]).call(o__16920__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__16920__auto__ = String;
return (o__16920__auto__["fromCharCode"]).call(o__16920__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__17751 = num_code;
switch (G__17751) {
case (1):
return (185);
...
var o__16920__auto__ = String;
return (o__16920__auto__["fromCharCode"]).call(o__16920__auto__,superscript_code);
});
/**
...
}catch (e17753){var _e__16927__auto__ = e17753;
return false;
}})())){
...
var vec__17754 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__17754,(0),null);
...
var or__4253__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
var temp__5722__auto__ = devtools.munging.goog$module$goog$object.getValueByKeys.call(null,devtools.munging.get_global_scope.call(null),ns_module_name.split("."));
if((temp__5722__auto__ == null)){
return null;
} else {
var ns_obj = temp__5722__auto__;
...
var len__4864__auto___17763 = arguments.length;
var i__4865__auto___17764 = (0);
while(true){
if((i__4865__auto___17764 < len__4864__auto___17763)){
args__4870__auto__.push((arguments[i__4865__auto___17764]));

var G__17765 = (i__4865__auto___17764 + (1));
i__4865__auto___17764 = G__17765;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__17759){
var vec__17760 = p__17759;
var ns_detector = cljs.core.nth.call(null,vec__17760,(0),null);
...
var G__17766 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__17767 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__17766;
remaining_tokens = G__17767;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq17757){
var G__17758 = cljs.core.first.call(null,seq17757);
var seq17757__$1 = cljs.core.next.call(null,seq17757);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17758,seq17757__$1);
}));
...
var vec__17771 = cljs.core.split_with.call(null,(function (p1__17770_SHARP_){
return cljs.core.not_EQ_.call(null,p1__17770_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__17771,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__17771,(1),null);
...
var vec__17777 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__17777,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__17777,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__17780 = cljs.core.rest.call(null,remaining_tokens);
var G__17781 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__17780;
name_tokens = G__17781;
continue;
} else {
...
var vec__17784 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__17784,(0),null);
var arity = cljs.core.nth.call(null,vec__17784,(1),null);
var vec__17787 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__17787,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__17787,(1),null);
var vec__17790 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__17790,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__17790,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__17790,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__17790,(3),null);
...
var vec__17796 = result;
var munged_ns = cljs.core.nth.call(null,vec__17796,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__17796,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__17796,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__17796,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__17796,(4),null);
var arity = cljs.core.nth.call(null,vec__17796,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__17800 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__17800,(0),null);
var args = cljs.core.nth.call(null,vec__17800,(1),null);
var vec__17803 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__17803,(0),null);
var name = cljs.core.nth.call(null,vec__17803,(1),null);
...
var G__17806 = (arity + (1));
var G__17807 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__17808){
var vec__17809 = p__17808;
var arity = cljs.core.nth.call(null,vec__17809,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__17809,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__17812_SHARP_){
return cljs.core.get.call(null,arities,p1__17812_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__17813_SHARP_){
return cljs.core.drop.call(null,(2),p1__17813_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___17820 = arguments.length;
var i__4865__auto___17821 = (0);
while(true){
if((i__4865__auto___17821 < len__4864__auto___17820)){
args__4870__auto__.push((arguments[i__4865__auto___17821]));

var G__17822 = (i__4865__auto___17821 + (1));
i__4865__auto___17821 = G__17822;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__17816){
var vec__17817 = p__17816;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__17817,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq17814){
var G__17815 = cljs.core.first.call(null,seq17814);
var seq17814__$1 = cljs.core.next.call(null,seq17814);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17815,seq17814__$1);
}));
...
var G__17823 = arg;
var G__17823__$1 = (((G__17823 instanceof cljs.core.Keyword))?G__17823.fqn:null);
switch (G__17823__$1) {
...
var map__17825 = options;
var map__17825__$1 = cljs.core.__destructure_map.call(null,map__17825);
var include_ns_QMARK_ = cljs.core.get.call(null,map__17825__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__17825__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__17825__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__17825__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__17826 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__17826,(0),null);
var fn_name = cljs.core.nth.call(null,vec__17826,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__17826,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__17826,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__17826,(4),null);
var arity = cljs.core.nth.call(null,vec__17826,(5),null);
...
var o__16920__auto__ = f;
return (o__16920__auto__["getBasis"]).call(o__16920__auto__);
});
/**
...
}catch (e17829){var _e__16927__auto__ = e17829;
...
var G__17830 = (obj[cljs.core.first.call(null,path)]);
var G__17831 = cljs.core.rest.call(null,path);
obj = G__17830;
path = G__17831;
continue;
} else {
...
var _STAR_ = (function (accum,p__17832){
var vec__17833 = p__17832;
var bit = cljs.core.nth.call(null,vec__17833,(0),null);
var protocol = cljs.core.nth.call(null,vec__17833,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__17836){
var vec__17837 = p__17836;
var ns = cljs.core.nth.call(null,vec__17837,(0),null);
var name = cljs.core.nth.call(null,vec__17837,(1),null);
var selector = cljs.core.nth.call(null,vec__17837,(2),null);
...
var post_process = (function (p__17841){
var vec__17842 = p__17841;
var munged_name = cljs.core.nth.call(null,vec__17842,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__17842,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__17840_SHARP_){
return (obj[cljs.core.first.call(null,p1__17840_SHARP_)]);
}),sorted_matches);
