...
var G__17861 = devtools.prefs.pref.call(null,v);
v = G__17861;
continue;
} else {
return v;
...
}catch (e17862){var _e__16927__auto__ = e17862;
return false;
}})();
...
}catch (e17864){var _e__16927__auto__ = e17864;
return false;
}})();
...
}catch (e17866){var _e__16927__auto__ = e17866;
return false;
}}
}
});
...
var vec__17868 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__17868,(0),null);
var name = cljs.core.nth.call(null,vec__17868,(1),null);
...
return cljs.core.some.call(null,(function (p1__17871_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__17871_SHARP_);
}),template);
});
