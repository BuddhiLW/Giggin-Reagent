...
var G__16969 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__16969,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__16970__delegate = function (args){
...
while (G__16971__i < G__16971__a.length) {G__16971__a[G__16971__i] = arguments[G__16971__i + 0]; ++G__16971__i;}
  args = new cljs.core.IndexedSeq(G__16971__a,0,null);
} 
return G__16970__delegate.call(this,args);};
G__16970.cljs$lang$maxFixedArity = 0;
G__16970.cljs$lang$applyTo = (function (arglist__16972){
var args = cljs.core.seq(arglist__16972);
return G__16970__delegate(args);
});
...
var G__16973 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__16973,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__16974__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
return G__16974__delegate.call(this,args);};
...
return G__16974__delegate(args);
});
...
var G__16977 = props;
var G__16977__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__16977,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__16977);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__16977__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__16978 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__16978,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__16978;
}
})(),id_class);
...
var G__16979 = (cljs.core.count.call(null,argv) - first_child);
switch (G__16979) {
case (0):
...
break;
case (1):
return reagent.impl.template.node$module$react.createElement(component,jsprops,reagent.impl.protocols.as_element.call(null,this$,cljs.core.nth.call(null,argv,first_child,null)));
...
var vec__16981 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__16981,(0),null);
var id = cljs.core.nth.call(null,vec__16981,(1),null);
var className = cljs.core.nth.call(null,vec__16981,(2),null);
...
var temp__5724__auto___16984 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___16984 == null)){
} else {
var key_16985 = temp__5724__auto___16984;
(jsprops.key = key_16985);
}
...
var temp__5724__auto___16986 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___16986 == null)){
} else {
var key_16987 = temp__5724__auto___16986;
(jsprops.key = key_16987);
}

return reagent.impl.template.node$module$react.createElement(reagent.impl.component.functional_render_fn.call(null,compiler,tag),jsprops);
});
/**
...
var temp__5724__auto___16988 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5724__auto___16988 == null)){
} else {
var key_16989 = temp__5724__auto___16988;
(jsprops.key = key_16989);
}

return reagent.impl.protocols.make_element.call(null,compiler,argv,reagent.impl.template.node$module$react.Fragment,jsprops,first_child);
});
...
var temp__5724__auto___16990 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___16990 == null)){
} else {
var key_16991 = temp__5724__auto___16990;
(jsprops.key = key_16991);
}
...
var temp__5724__auto___16992 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___16992 == null)){
} else {
var key_16993 = temp__5724__auto___16992;
(jsprops.key = key_16993);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__16994_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__16994_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__16995 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__16995,(0),null);
var derefed = cljs.core.nth.call(null,vec__16995,(1),null);
...
break;
default:
var G__17000 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__17001 = compiler;
v = G__17000;
compiler = G__17001;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template17005 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template17005 = (function (opts,id,fn_to_element,parse_fn,meta17006){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template17005.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17007,meta17006__$1){
var self__ = this;
var _17007__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template17005(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta17006__$1));
}));

(reagent.impl.template.t_reagent$impl$template17005.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17007){
var self__ = this;
var _17007__$1 = this;
return self__.meta17006;
}));

(reagent.impl.template.t_reagent$impl$template17005.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template17005.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template17005.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template17005.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template17005.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template17005.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta17006","meta17006",-1400682173,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template17005.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template17005.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template17005");

(reagent.impl.template.t_reagent$impl$template17005.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template17005");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template17005.
 */
reagent.impl.template.__GT_t_reagent$impl$template17005 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template17005(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta17006){
return (new reagent.impl.template.t_reagent$impl$template17005(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta17006));
});

}

return (new reagent.impl.template.t_reagent$impl$template17005(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
