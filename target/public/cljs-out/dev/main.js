...
window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=8c122b&fwbuild=dev","cljs.core._STAR_target_STAR_":"bundle"};
...
document.write('<script>goog.require("giggin.core");</script>');
