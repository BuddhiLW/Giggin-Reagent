...
var G__18651 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__18651,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__18651;
}
}));
...
var len__4864__auto___18656 = arguments.length;
var i__4865__auto___18657 = (0);
while(true){
if((i__4865__auto___18657 < len__4864__auto___18656)){
args__4870__auto__.push((arguments[i__4865__auto___18657]));

var G__18658 = (i__4865__auto___18657 + (1));
i__4865__auto___18657 = G__18658;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq18653){
var G__18654 = cljs.core.first.call(null,seq18653);
var seq18653__$1 = cljs.core.next.call(null,seq18653);
var G__18655 = cljs.core.first.call(null,seq18653__$1);
var seq18653__$2 = cljs.core.next.call(null,seq18653__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18654,G__18655,seq18653__$2);
}));
...
var map__18660 = m;
var map__18660__$1 = cljs.core.__destructure_map.call(null,map__18660);
var file = cljs.core.get.call(null,map__18660__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__18660__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__18660__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__18659_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__18659_SHARP_));
...
var temp__5720__auto___18661 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___18661)){
var message_18662 = temp__5720__auto___18661;
cljs.core.println.call(null,message_18662);
} else {
}
...
var temp__5720__auto___18663 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___18663)){
var message_18664 = temp__5720__auto___18663;
cljs.core.println.call(null,message_18664);
} else {
}
...
var output_dir__$1 = (function (){var G__18665 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__18665,"/"].join('');
} else {
return G__18665;
}
})();
...
var G__18666 = exception.stack;
var G__18666__$1 = (((G__18666 == null))?null:clojure.string.split_lines.call(null,G__18666));
var G__18666__$2 = (((G__18666__$1 == null))?null:cljs.core.get.call(null,G__18666__$1,depth));
if((G__18666__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__18666__$2);
}
} else {
...
var vec__18667 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__18667,(0),null);
var column = cljs.core.nth.call(null,vec__18667,(1),null);
var vec__18670 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__18670,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__18670,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__18670,(2),null);
...
var m__$1 = (function (){var G__18673 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__18677 = (function (){var G__18676 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__18676);
} else {
return G__18676;
}
})();
...
return cljs.core.vary_meta.call(null,G__18678,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__18682 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__18682,(0),null);
var types = vec__18682;
...
return cljs.core.map.call(null,(function (p__18685){
var vec__18686 = p__18685;
var ns = cljs.core.nth.call(null,vec__18686,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__18686,(1),null);
return (function (){
...
var G__18689 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__18690 = cljs.core.seq.call(null,vars__$1);
var chunk__18691 = null;
var count__18692 = (0);
var i__18693 = (0);
while(true){
if((i__18693 < count__18692)){
var v = cljs.core._nth.call(null,chunk__18691,i__18693);
var temp__5720__auto___18695 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___18695)){
var t_18696 = temp__5720__auto___18695;
each_fixture_fn.call(null,((function (seq__18690,chunk__18691,count__18692,i__18693,t_18696,temp__5720__auto___18695,v,each_fixture_fn,G__18689,G__18689__$1,env,once_fixtures,each_fixtures,vec__18686,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_18696)));
});})(seq__18690,chunk__18691,count__18692,i__18693,t_18696,temp__5720__auto___18695,v,each_fixture_fn,G__18689,G__18689__$1,env,once_fixtures,each_fixtures,vec__18686,ns,vars__$1))
);
} else {
}


var G__18697 = seq__18690;
var G__18698 = chunk__18691;
var G__18699 = count__18692;
var G__18700 = (i__18693 + (1));
seq__18690 = G__18697;
chunk__18691 = G__18698;
count__18692 = G__18699;
i__18693 = G__18700;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__18690);
if(temp__5720__auto__){
var seq__18690__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__18690__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__18690__$1);
var G__18701 = cljs.core.chunk_rest.call(null,seq__18690__$1);
var G__18702 = c__4679__auto__;
var G__18703 = cljs.core.count.call(null,c__4679__auto__);
var G__18704 = (0);
seq__18690 = G__18701;
chunk__18691 = G__18702;
count__18692 = G__18703;
i__18693 = G__18704;
continue;
} else {
var v = cljs.core.first.call(null,seq__18690__$1);
var temp__5720__auto___18705__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___18705__$1)){
var t_18706 = temp__5720__auto___18705__$1;
each_fixture_fn.call(null,((function (seq__18690,chunk__18691,count__18692,i__18693,t_18706,temp__5720__auto___18705__$1,v,seq__18690__$1,temp__5720__auto__,each_fixture_fn,G__18689,G__18689__$1,env,once_fixtures,each_fixtures,vec__18686,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_18706)));
});})(seq__18690,chunk__18691,count__18692,i__18693,t_18706,temp__5720__auto___18705__$1,v,seq__18690__$1,temp__5720__auto__,each_fixture_fn,G__18689,G__18689__$1,env,once_fixtures,each_fixtures,vec__18686,ns,vars__$1))
);
} else {
}


var G__18707 = cljs.core.next.call(null,seq__18690__$1);
var G__18708 = null;
var G__18709 = (0);
var G__18710 = (0);
seq__18690 = G__18707;
chunk__18691 = G__18708;
count__18692 = G__18709;
i__18693 = G__18710;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__18689__$1)].join('')));
